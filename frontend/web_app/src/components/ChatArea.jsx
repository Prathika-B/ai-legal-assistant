  ...
  const samplePrompts = [
    {
      ...
      prompt: "What are the major differences between the new BNS (Bharatiya Nyaya Sanhita) 2023 and the old IPC regarding theft and criminal intimidation?",
    },
    {
      icon: "🛡️",
      title: "Bail Procedure under BNSS",
      desc: "What are the legal procedure rules for bail and filing complaints under BNSS 2023?",
      prompt: "What are the procedures for filing complaints and applying for bail under the new BNSS (Bharatiya Nagarik Suraksha Sanhita) 2023?",
    },
    {
      icon: "⚖️",
      title: "Contract & Notice Rules",
      desc: "What is the legal process for issuing legal notices for breach of contract in India?",
      prompt: "What is the standard procedure and legal requirements for issuing a Legal Notice for breach of contract in India?",
    },
    {
      icon: "📄",
    ...
    <div className="main-content">
      ...
      <header className="top-header">
        <div className="header-left">
          {isSidebarCollapsed && (
            <button className="icon-button" onClick={onToggleSidebar} title="Open sidebar">
              <Menu size={18} />
            </button>
          )}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <button
            ...
            style={{ width: "auto", padding: "0 10px", gap: "6px", fontSize: "0.82rem" }}
          >
        ...
        <div className="chat-wrapper">
          {messages.length === 0 ? (
            ...
            messages.map((msg, index) => {
              ...
              return (
                <div key={index} className="message-bubble-wrapper">
                  <div className={`message-bubble ${isUser ? "user" : "assistant"}`}>
                    <div className={`msg-avatar ${isUser ? "user-av" : "assistant-av"}`}>
                      {isUser ? (userEmail ? userEmail.charAt(0).toUpperCase() : <User size={16} />) : <Scale size={18} />}
                    </div>
                    ...
                    <div className="msg-content">
                      {isUser ? (
                        ...
                        <>
                          ...
                          {/* Source Citations Box if sources exist */}
                          {msg.sources && msg.sources.length > 0 && (
                            <div className="sources-box">
                              <div className="sources-header">
                                <BookOpen size={14} />
                                <span>Retrieved Statutory Context & Acts</span>
                              </div>
                          ...
                          <div className="msg-actions">
                            <button className="action-btn" onClick={() => handleCopy(msg.content, index)}>
                              {copiedIndex === index ? (
                                <>
                            ...
                            <button className="action-btn" title="Helpful answer">
                              <ThumbsUp size={13} />
                            </button>
                            <button className="action-btn" title="Needs improvement">
                              <ThumbsDown size={13} />
                            </button>
                          </div>
                        </>
            ...
            <div className="message-bubble-wrapper">
              <div className="message-bubble assistant">
                ...
                <div className="msg-content" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <span style={{ color: "var(--text-secondary)", fontSize: "0.9rem" }}>Searching Indian Law Corpus & generating response...</span>
